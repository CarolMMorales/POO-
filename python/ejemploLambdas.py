...
print("Imprimir usando Lambdas")
listadoResultado = list(filter(lambda vehiculo : vehiculo.obtenerPrecio() < 100000000, listadoVeh));
for veh in listadoResultado:
    print(veh.obtenerInformacion());